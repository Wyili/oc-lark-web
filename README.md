...
这是 oc-lark 的产品官网与 GitHub Pages 静态落地页。当前为第四轮 UI 改造版（`web-refresh-04`），使用单文件 `index.html`，以深色背景、蓝紫/青色渐变、克制的网格光晕和终端视觉呈现成熟 landing page 的节奏，同时保持浅色内容卡片上的高对比度。页面包含品牌导航、中心化 Hero、版本与许可证信息、终端展示、核心特性、架构流程、CLI/飞书命令、配置指南、效果展示、本地控制台、FAQ 与页脚。
